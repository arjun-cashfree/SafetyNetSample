...
public class DeviceValidationAPI extends BaseApi {

    private static final String TAG = DeviceValidationAPI.class.getName();
    ...
    public void validateDevice(String signedDeviceId, String deviceId, String authCode, String pares, String xCorrID, APISuccessListener successListener, APIErrorListener errorListener) {
        String body = "{" +
                "  \"customerDetails\": {" +
